...
class Mapping0 extends FuncMapping {
  ...
  synchronized int inverse(Block vb, Object l) {
    ...
    for (i = 0; i < vi.channels; i++) {
      ...
      this.floormemo[i] = look.floor_func[submap]
        .inverse1(vb, look.floor_look[submap], this.floormemo[i]);
    ...
    for (i = 0; i < info.submaps; i++) {
      ...
      look.residue_func[i].inverse(vb, look.residue_look[i], this.pcmbundle, 
          this.zerobundle, ch_in_bundle);
    } 
