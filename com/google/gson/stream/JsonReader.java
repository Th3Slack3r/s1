...
public class JsonReader implements Closeable {
  ...
  public long nextLong() throws IOException {
    ...
    if (result != asDouble)
      throw new NumberFormatException("Expected a long but was " + this.peekedString + " at line " + 
          getLineNumber() + " column " + getColumnNumber() + " path " + getPath()); 
    this.peekedString = null;
    this.peeked = 0;
    this.pathIndices[this.stackSize - 1] = this.pathIndices[this.stackSize - 1] + 1;
  ...
  public int nextInt() throws IOException {
    ...
    if (p == 15) {
      ...
      if (this.peekedLong != i)
        throw new NumberFormatException("Expected an int but was " + this.peekedLong + " at line " + 
            getLineNumber() + " column " + getColumnNumber() + " path " + getPath()); 
      this.peeked = 0;
      this.pathIndices[this.stackSize - 1] = this.pathIndices[this.stackSize - 1] + 1;
      return i;
    ...
    if (result != asDouble)
      throw new NumberFormatException("Expected an int but was " + this.peekedString + " at line " + 
          getLineNumber() + " column " + getColumnNumber() + " path " + getPath()); 
    this.peekedString = null;
    this.peeked = 0;
    this.pathIndices[this.stackSize - 1] = this.pathIndices[this.stackSize - 1] + 1;
    ...
    JsonReaderInternalAccess.INSTANCE = new JsonReaderInternalAccess() {
        public void promoteNameToValue(JsonReader reader) throws IOException {
          ...
          if (p == 13) {
            ...
            throw new IllegalStateException("Expected a name but was " + reader.peek() + " " + " at line " + reader
                .getLineNumber() + " column " + reader.getColumnNumber() + " path " + reader
                .getPath());
          } 
        }
      };
