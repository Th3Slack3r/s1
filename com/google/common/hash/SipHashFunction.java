...
final class SipHashFunction extends AbstractStreamingHashFunction implements Serializable {
  ...
  public String toString() {
    int i = this.c, j = this.d;
    long l1 = this.k0, l2 = this.k1;
    return (new StringBuilder(81)).append("Hashing.sipHash").append(i).append(j).append("(").append(l1).append(", ").append(l2).append(")").toString();
  }
