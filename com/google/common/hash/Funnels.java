...
public final class Funnels {
  ...
  private static class StringCharsetFunnel implements Funnel<CharSequence>, Serializable {
    ...
    public String toString() {
      ...
      return (new StringBuilder(22 + str.length())).append("Funnels.stringFunnel(").append(str).append(")").toString();
    }
  ...
  private static class SequentialFunnel<E> implements Funnel<Iterable<? extends E>>, Serializable {
    ...
    public String toString() {
      ...
      return (new StringBuilder(26 + str.length())).append("Funnels.sequentialFunnel(").append(str).append(")").toString();
    }
  ...
  private static class SinkAsStream extends OutputStream {
    ...
    public String toString() {
      ...
      return (new StringBuilder(24 + str.length())).append("Funnels.asOutputStream(").append(str).append(")").toString();
    }
  }
}
