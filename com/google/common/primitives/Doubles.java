...
public final class Doubles {
  ...
  private static Pattern fpPattern() {
    ...
    String str1 = String.valueOf(String.valueOf(hex)), completeHex = (new StringBuilder(25 + str1.length())).append("0[xX]").append(str1).append("[pP][+-]?\\d++[fFdD]?").toString();
    String str2 = String.valueOf(String.valueOf(completeDec)), str3 = String.valueOf(String.valueOf(completeHex)), fpPattern = (new StringBuilder(23 + str2.length() + str3.length())).append("[+-]?(?:NaN|Infinity|").append(str2).append("|").append(str3).append(")").toString();
