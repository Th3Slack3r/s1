...
public abstract class TypeToken<T> extends TypeCapture<T> implements Serializable {
  ...
  public final Invokable<T, Object> method(Method method) {
    ...
    return new Invokable.MethodInvokable<T>(method) {
        ...
        public String toString() {
          String str1 = String.valueOf(String.valueOf(getOwnerType())), str2 = String.valueOf(String.valueOf(super.toString()));
  ...
  public final Invokable<T, T> constructor(Constructor<?> constructor) {
    ...
    return new Invokable.ConstructorInvokable<T>(constructor) {
        ...
        public String toString() {
          String str1 = String.valueOf(String.valueOf(getOwnerType())), str2 = String.valueOf(String.valueOf(Joiner.on(", ").join((Object[])getGenericParameterTypes())));
  ...
  final TypeToken<T> rejectTypeVariables() {
    (new TypeVisitor() {
        void visitTypeVariable(TypeVariable<?> type) {
          String str = String.valueOf(String.valueOf(TypeToken.this.runtimeType));
          throw new IllegalArgumentException((new StringBuilder(58 + str.length())).append(str).append("contains a type variable and is not safe for the operation").toString());
        }
  ...
  private static Type supertypeBound(WildcardType type) {
    ...
    if (upperBounds.length == 0)
      return Object.class; 
    String str = String.valueOf(String.valueOf(type));
    throw new AssertionError((new StringBuilder(59 + str.length())).append("There should be at most one upper bound for wildcard type: ").append(str).toString());
  }
  ...
  private static Type subtypeBound(WildcardType type) {
    ...
    if (lowerBounds.length == 0)
      return null; 
    String str = String.valueOf(String.valueOf(type));
    throw new AssertionError((new StringBuilder(46 + str.length())).append("Wildcard should have at most one lower bound: ").append(str).toString());
  }
  ...
  private TypeToken<? super T> getSupertypeFromUpperBounds(Class<? super T> supertype, Type[] upperBounds) {
    ...
    String str1 = String.valueOf(String.valueOf(supertype)), str2 = String.valueOf(String.valueOf(this));
    throw new IllegalArgumentException((new StringBuilder(23 + str1.length() + str2.length())).append(str1).append(" isn't a super type of ").append(str2).toString());
  }
  ...
  private TypeToken<? extends T> getSubtypeFromLowerBounds(Class<?> subclass, Type[] lowerBounds) {
    ...
    String str1 = String.valueOf(String.valueOf(subclass)), str2 = String.valueOf(String.valueOf(this));
    throw new IllegalArgumentException((new StringBuilder(21 + str1.length() + str2.length())).append(str1).append(" isn't a subclass of ").append(str2).toString());
  }
