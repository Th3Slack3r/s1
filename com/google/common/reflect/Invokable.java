...
public abstract class Invokable<T, R> extends Element implements GenericDeclaration {
  ...
  public final <R1 extends R> Invokable<T, R1> returning(TypeToken<R1> returnType) {
    if (!returnType.isAssignableFrom(getReturnType())) {
      String str1 = String.valueOf(String.valueOf(getReturnType())), str2 = String.valueOf(String.valueOf(returnType));
      throw new IllegalArgumentException((new StringBuilder(35 + str1.length() + str2.length())).append("Invokable is known to return ").append(str1).append(", not ").append(str2).toString());
    } 
  ...
  static class ConstructorInvokable<T> extends Invokable<T, T> {
    ...
    final Object invokeInternal(@Nullable Object receiver, Object[] args) throws InvocationTargetException, IllegalAccessException {
      try {
        ...
        throw new RuntimeException((new StringBuilder(8 + str.length())).append(str).append(" failed.").toString(), e);
      } 
    }
