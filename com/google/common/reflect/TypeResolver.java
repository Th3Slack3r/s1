...
public final class TypeResolver {
  ...
  private static void populateTypeMappings(final Map<TypeVariableKey, Type> mappings, Type from, final Type to) {
    ...
    (new TypeVisitor() {
        ...
        void visitClass(Class<?> fromClass) {
          String str = String.valueOf(String.valueOf(fromClass));
          throw new IllegalArgumentException((new StringBuilder(21 + str.length())).append("No type mapping from ").append(str).toString());
        }
      }).visit(new Type[] { from });
  }
  ...
  private static <T> T expectArgument(Class<T> type, Object arg) {
    try {
      ...
      String str1 = String.valueOf(String.valueOf(arg)), str2 = String.valueOf(String.valueOf(type.getSimpleName()));
      throw new IllegalArgumentException((new StringBuilder(10 + str1.length() + str2.length())).append(str1).append(" is not a ").append(str2).toString());
    } 
  }
    ...
    Type capture(Type type) {
      ...
      if (type instanceof WildcardType) {
        ...
        if (lowerBounds.length == 0) {
          ...
          String str1 = String.valueOf(String.valueOf(Joiner.on('&').join((Object[])upperBounds))), name = (new StringBuilder(33 + str1.length())).append("capture#").append(i).append("-of ? extends ").append(str1).toString();
