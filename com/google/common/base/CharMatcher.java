...
public abstract class CharMatcher implements Predicate<Character> {
  ...
  public static CharMatcher is(final char match) {
    String str1 = String.valueOf(String.valueOf(showCharacter(match))), description = (new StringBuilder(18 + str1.length())).append("CharMatcher.is('").append(str1).append("')").toString();
  ...
  public static CharMatcher isNot(final char match) {
    String str1 = String.valueOf(String.valueOf(showCharacter(match))), description = (new StringBuilder(21 + str1.length())).append("CharMatcher.isNot('").append(str1).append("')").toString();
    return new FastMatcher(description) {
        public boolean matches(char c) {
          return (c != match);
        }
  ...
  private static CharMatcher isEither(final char match1, final char match2) {
    String str1 = String.valueOf(String.valueOf(showCharacter(match1))), str2 = String.valueOf(String.valueOf(showCharacter(match2))), description = (new StringBuilder(21 + str1.length() + str2.length())).append("CharMatcher.anyOf(\"").append(str1).append(str2).append("\")").toString();
    return new FastMatcher(description) {
        public boolean matches(char c) {
  ...
  public static CharMatcher inRange(char startInclusive, char endInclusive) {
    ...
    String str1 = String.valueOf(String.valueOf(showCharacter(startInclusive))), str2 = String.valueOf(String.valueOf(showCharacter(endInclusive))), description = (new StringBuilder(27 + str1.length() + str2.length())).append("CharMatcher.inRange('").append(str1).append("', '").append(str2).append("')").toString();
  ...
  public static CharMatcher forPredicate(final Predicate<? super Character> predicate) {
    ...
    String str1 = String.valueOf(String.valueOf(predicate)), description = (new StringBuilder(26 + str1.length())).append("CharMatcher.forPredicate(").append(str1).append(")").toString();
  ...
  private static class NegatedMatcher extends CharMatcher {
    ...
    NegatedMatcher(CharMatcher original) {
      this((new StringBuilder(9 + str.length())).append(str).append(".negate()").toString(), original);
    }
  ...
  private static class And extends CharMatcher {
    ...
    And(CharMatcher a, CharMatcher b) {
      this(a, b, (new StringBuilder(19 + str1.length() + str2.length())).append("CharMatcher.and(").append(str1).append(", ").append(str2).append(")").toString());
    }
  ...
  private static class Or extends CharMatcher {
    ...
    Or(CharMatcher a, CharMatcher b) {
      this(a, b, (new StringBuilder(18 + str1.length() + str2.length())).append("CharMatcher.or(").append(str1).append(", ").append(str2).append(")").toString());
    }
  ...
  CharMatcher precomputedInternal() {
    ...
    String negatedDescription = this.description.endsWith(suffix) ? this.description.substring(0, this.description.length() - suffix.length()) : ((String.valueOf(suffix).length() != 0) ? String.valueOf(this.description).concat(String.valueOf(suffix)) : new String(String.valueOf(this.description)));
