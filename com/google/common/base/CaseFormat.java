...
public enum CaseFormat {
  ...
  private static final class StringConverter extends Converter<String, String> implements Serializable {
    ...
    public String toString() {
      String str1 = String.valueOf(String.valueOf(this.sourceFormat)), str2 = String.valueOf(String.valueOf(this.targetFormat));
      return (new StringBuilder(14 + str1.length() + str2.length())).append(str1).append(".converterTo(").append(str2).append(")").toString();
    }
  }
