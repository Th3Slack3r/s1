...
public final class Predicates {
  ...
  private static class NotPredicate<T> implements Predicate<T>, Serializable {
    ...
    public String toString() {
      String str = String.valueOf(String.valueOf(this.predicate.toString()));
      return (new StringBuilder(16 + str.length())).append("Predicates.not(").append(str).append(")").toString();
    }
  }
  ...
  private static class AndPredicate<T> implements Predicate<T>, Serializable {
    ...
    public String toString() {
      String str = String.valueOf(String.valueOf(Predicates.COMMA_JOINER.join(this.components)));
      return (new StringBuilder(16 + str.length())).append("Predicates.and(").append(str).append(")").toString();
    }
  }
  ...
  private static class OrPredicate<T> implements Predicate<T>, Serializable {
    ...
    public String toString() {
      String str = String.valueOf(String.valueOf(Predicates.COMMA_JOINER.join(this.components)));
      return (new StringBuilder(15 + str.length())).append("Predicates.or(").append(str).append(")").toString();
    }
  }
  ...
  private static class IsEqualToPredicate<T> implements Predicate<T>, Serializable {
    ...
    public String toString() {
      String str = String.valueOf(String.valueOf(this.target));
      return (new StringBuilder(20 + str.length())).append("Predicates.equalTo(").append(str).append(")").toString();
    }
  }
  ...
  private static class InstanceOfPredicate implements Predicate<Object>, Serializable {
    ...
    public String toString() {
      String str = String.valueOf(String.valueOf(this.clazz.getName()));
      return (new StringBuilder(23 + str.length())).append("Predicates.instanceOf(").append(str).append(")").toString();
    }
  }
  ...
  private static class AssignableFromPredicate implements Predicate<Class<?>>, Serializable {
    ...
    public String toString() {
      String str = String.valueOf(String.valueOf(this.clazz.getName()));
      return (new StringBuilder(27 + str.length())).append("Predicates.assignableFrom(").append(str).append(")").toString();
    }
  }
  ...
  private static class InPredicate<T> implements Predicate<T>, Serializable {
    ...
    public String toString() {
      String str = String.valueOf(String.valueOf(this.target));
      return (new StringBuilder(15 + str.length())).append("Predicates.in(").append(str).append(")").toString();
    }
  }
  ...
  private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
    ...
    public String toString() {
      String str1 = String.valueOf(String.valueOf(this.p.toString())), str2 = String.valueOf(String.valueOf(this.f.toString()));
      return (new StringBuilder(2 + str1.length() + str2.length())).append(str1).append("(").append(str2).append(")").toString();
    }
  }
  ...
  private static class ContainsPatternPredicate implements Predicate<CharSequence>, Serializable {
    ...
    public String toString() {
      ...
      String str1 = String.valueOf(String.valueOf(patternString));
      return (new StringBuilder(21 + str1.length())).append("Predicates.contains(").append(str1).append(")").toString();
    }
  }
  ...
  private static class ContainsPatternFromStringPredicate extends ContainsPatternPredicate {
    ...
    public String toString() {
      String str = String.valueOf(String.valueOf(this.pattern.pattern()));
      return (new StringBuilder(28 + str.length())).append("Predicates.containsPattern(").append(str).append(")").toString();
    }
  }
