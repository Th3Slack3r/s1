...
public abstract class Equivalence<T> {
  ...
  public static final class Wrapper<T> implements Serializable {
    ...
    public String toString() {
      String str1 = String.valueOf(String.valueOf(this.equivalence)), str2 = String.valueOf(String.valueOf(this.reference));
      return (new StringBuilder(7 + str1.length() + str2.length())).append(str1).append(".wrap(").append(str2).append(")").toString();
    }
  }
  ...
  private static final class EquivalentToPredicate<T> implements Predicate<T>, Serializable {
    ...
    public String toString() {
      String str1 = String.valueOf(String.valueOf(this.equivalence)), str2 = String.valueOf(String.valueOf(this.target));
      return (new StringBuilder(15 + str1.length() + str2.length())).append(str1).append(".equivalentTo(").append(str2).append(")").toString();
    }
  }
