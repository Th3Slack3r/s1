...
final class FunctionalEquivalence<F, T> extends Equivalence<F> implements Serializable {
  ...
  public String toString() {
    String str1 = String.valueOf(String.valueOf(this.resultEquivalence)), str2 = String.valueOf(String.valueOf(this.function));
    return (new StringBuilder(13 + str1.length() + str2.length())).append(str1).append(".onResultOf(").append(str2).append(")").toString();
  }
}
