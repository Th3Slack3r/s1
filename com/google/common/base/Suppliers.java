...
public final class Suppliers {
  ...
  private static class SupplierComposition<F, T> implements Supplier<T>, Serializable {
    ...
    public String toString() {
      String str1 = String.valueOf(String.valueOf(this.function)), str2 = String.valueOf(String.valueOf(this.supplier));
      return (new StringBuilder(21 + str1.length() + str2.length())).append("Suppliers.compose(").append(str1).append(", ").append(str2).append(")").toString();
    }
  }
  ...
  static class MemoizingSupplier<T> implements Supplier<T>, Serializable {
    ...
    public String toString() {
      ...
      return (new StringBuilder(19 + str.length())).append("Suppliers.memoize(").append(str).append(")").toString();
    }
  }
  ...
  static class ExpiringMemoizingSupplier<T> implements Supplier<T>, Serializable {
    ...
    public String toString() {
      ...
      return (new StringBuilder(62 + str.length())).append("Suppliers.memoizeWithExpiration(").append(str).append(", ").append(l).append(", NANOS)").toString();
    }
  }
  ...
  private static class SupplierOfInstance<T> implements Supplier<T>, Serializable {
    ...
    public String toString() {
      ...
      return (new StringBuilder(22 + str.length())).append("Suppliers.ofInstance(").append(str).append(")").toString();
    }
  }
  ...
  private static class ThreadSafeSupplier<T> implements Supplier<T>, Serializable {
    ...
    public String toString() {
      String str = String.valueOf(String.valueOf(this.delegate));
      return (new StringBuilder(32 + str.length())).append("Suppliers.synchronizedSupplier(").append(str).append(")").toString();
    }
  }
