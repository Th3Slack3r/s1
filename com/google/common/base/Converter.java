...
public abstract class Converter<A, B> implements Function<A, B> {
  ...
  private static final class ReverseConverter<A, B> extends Converter<B, A> implements Serializable {
    ...
    public String toString() {
      ...
      return (new StringBuilder(10 + str.length())).append(str).append(".reverse()").toString();
    }
  }
  ...
  private static final class ConverterComposition<A, B, C> extends Converter<A, C> implements Serializable {
    ...
    public String toString() {
      String str1 = String.valueOf(String.valueOf(this.first)), str2 = String.valueOf(String.valueOf(this.second));
      return (new StringBuilder(10 + str1.length() + str2.length())).append(str1).append(".andThen(").append(str2).append(")").toString();
    }
  }
  ...
  private static final class FunctionBasedConverter<A, B> extends Converter<A, B> implements Serializable {
    ...
    public String toString() {
      String str1 = String.valueOf(String.valueOf(this.forwardFunction)), str2 = String.valueOf(String.valueOf(this.backwardFunction));
      return (new StringBuilder(18 + str1.length() + str2.length())).append("Converter.from(").append(str1).append(", ").append(str2).append(")").toString();
    }
  }
