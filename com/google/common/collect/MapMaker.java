...
public final class MapMaker extends GenericMapMaker<Object, Object> {
  ...
  static final class ComputingMapAdapter<K, V> extends ComputingConcurrentHashMap<K, V> implements Serializable {
    ...
    public V get(Object key) {
      ...
      if (value == null) {
        String str1 = String.valueOf(String.valueOf(this.computingFunction)), str2 = String.valueOf(String.valueOf(key));
        throw new NullPointerException((new StringBuilder(24 + str1.length() + str2.length())).append(str1).append(" returned null for key ").append(str2).append(".").toString());
      } 
      return value;
    }
  }
