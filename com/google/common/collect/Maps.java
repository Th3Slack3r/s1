...
public final class Maps {
  ...
  static class ValueDifferenceImpl<V> implements MapDifference.ValueDifference<V> {
    ...
    public String toString() {
      String str1 = String.valueOf(String.valueOf(this.left)), str2 = String.valueOf(String.valueOf(this.right));
      return (new StringBuilder(4 + str1.length() + str2.length())).append("(").append(str1).append(", ").append(str2).append(")").toString();
    }
  }
  ...
  private static final class BiMapConverter<A, B> extends Converter<A, B> implements Serializable {
    ...
    public String toString() {
      ...
      return (new StringBuilder(18 + str.length())).append("Maps.asConverter(").append(str).append(")").toString();
    }
  }
