...
public final class TreeRangeMap<K extends Comparable, V> implements RangeMap<K, V> {
  ...
  private static final RangeMap EMPTY_SUB_RANGE_MAP = new RangeMap<Comparable, Object>() {
      ...
      public void put(Range range, Object value) {
        ...
        String str = String.valueOf(String.valueOf(range));
        throw new IllegalArgumentException((new StringBuilder(46 + str.length())).append("Cannot insert range ").append(str).append(" into an empty subRangeMap").toString());
      }
      ...
      public Set<Map.Entry<Range<K>, V>> entrySet() {
        return (Set)new Maps.EntrySet<Range<Range<K>>, V>() {
            ...
            public Iterator<Map.Entry<Range<K>, V>> iterator() {
              ...
              Cut<K> cutToStart = (Cut<K>)MoreObjects.firstNonNull(TreeRangeMap.this.entriesByLowerBound.floorKey(TreeRangeMap.SubRangeMap.this.subRange.lowerBound), TreeRangeMap.SubRangeMap.this.subRange.lowerBound);
