...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
  ...
  static void checkNoConflict(boolean safe, String conflictDescription, Map.Entry<?, ?> entry1, Map.Entry<?, ?> entry2) {
    if (!safe) {
      String str1 = String.valueOf(String.valueOf(conflictDescription)), str2 = String.valueOf(String.valueOf(entry1)), str3 = String.valueOf(String.valueOf(entry2));
      throw new IllegalArgumentException((new StringBuilder(34 + str1.length() + str2.length() + str3.length())).append("Multiple entries with same ").append(str1).append(": ").append(str2).append(" and ").append(str3).toString());
    } 
  }
