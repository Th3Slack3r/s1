...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V> {
  ...
  public ImmutableMap<R, V> column(C columnKey) {
    ...
    return (ImmutableMap<R, V>)MoreObjects.firstNonNull(columnMap().get(columnKey), ImmutableMap.of());
  }
  ...
  public ImmutableMap<C, V> row(R rowKey) {
    ...
    return (ImmutableMap<C, V>)MoreObjects.firstNonNull(rowMap().get(rowKey), ImmutableMap.of());
  }
