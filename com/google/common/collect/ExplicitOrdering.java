...
final class ExplicitOrdering<T> extends Ordering<T> implements Serializable {
  ...
  public String toString() {
    String str = String.valueOf(String.valueOf(this.rankMap.keySet()));
    return (new StringBuilder(19 + str.length())).append("Ordering.explicit(").append(str).append(")").toString();
  }
}
