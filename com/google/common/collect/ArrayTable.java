...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
  ...
  private static abstract class ArrayMap<K, V> extends Maps.ImprovedAbstractMap<K, V> {
    ...
    public V put(K key, V value) {
      Integer index = this.keyIndex.get(key);
      if (index == null) {
        String str1 = String.valueOf(String.valueOf(getKeyRole())), str2 = String.valueOf(String.valueOf(key)), str3 = String.valueOf(String.valueOf(this.keyIndex.keySet()));
        throw new IllegalArgumentException((new StringBuilder(9 + str1.length() + str2.length() + str3.length())).append(str1).append(" ").append(str2).append(" not in ").append(str3).toString());
      } 
