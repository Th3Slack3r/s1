...
public final class Collections2 {
  ...
  private static final class OrderedPermutationCollection<E> extends AbstractCollection<List<E>> {
    ...
    public String toString() {
      String str = String.valueOf(String.valueOf(this.inputList));
      return (new StringBuilder(30 + str.length())).append("orderedPermutationCollection(").append(str).append(")").toString();
    }
  }
  ...
  private static final class PermutationCollection<E> extends AbstractCollection<List<E>> {
    ...
    public String toString() {
      String str = String.valueOf(String.valueOf(this.inputList));
      return (new StringBuilder(14 + str.length())).append("permutations(").append(str).append(")").toString();
    }
  }
