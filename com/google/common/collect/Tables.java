...
public final class Tables {
  ...
  static abstract class AbstractCell<R, C, V> implements Table.Cell<R, C, V> {
    ...
    public String toString() {
      String str1 = String.valueOf(String.valueOf(getRowKey())), str2 = String.valueOf(String.valueOf(getColumnKey())), str3 = String.valueOf(String.valueOf(getValue()));
      return (new StringBuilder(4 + str1.length() + str2.length() + str3.length())).append("(").append(str1).append(",").append(str2).append(")=").append(str3).toString();
    }
  }
