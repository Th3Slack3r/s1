...
public final class Iterators {
  ...
  public static <T> T getOnlyElement(Iterator<T> iterator) {
    ...
    String str = String.valueOf(String.valueOf(first));
    sb.append((new StringBuilder(31 + str.length())).append("expected one element but was: <").append(str).toString());
    for (int i = 0; i < 4 && iterator.hasNext(); i++) {
      String str1 = String.valueOf(String.valueOf(iterator.next()));
      sb.append((new StringBuilder(2 + str1.length())).append(", ").append(str1).toString());
    } 
    if (iterator.hasNext())
      sb.append(", ..."); 
    sb.append('>');
