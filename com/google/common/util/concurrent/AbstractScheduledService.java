...
public abstract class AbstractScheduledService implements Service {
  ...
  private final AbstractService delegate = new AbstractService() {
      ...
      protected final void doStart() {
        this.executorService = MoreExecutors.renamingDecorator(AbstractScheduledService.this.executor(), new Supplier<String>() {
              public String get() {
                String str1 = String.valueOf(String.valueOf(AbstractScheduledService.this.serviceName())), str2 = String.valueOf(String.valueOf(AbstractScheduledService.null.this.state()));
  ...
  public String toString() {
    String str1 = String.valueOf(String.valueOf(serviceName())), str2 = String.valueOf(String.valueOf(state()));
