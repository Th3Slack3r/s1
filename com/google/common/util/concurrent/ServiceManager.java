...
public final class ServiceManager {
  ...
  public ServiceManager startAsync() {
    ...
    for (Service service : this.services) {
      try {
        ...
        String str = String.valueOf(String.valueOf(service));
        logger.log(Level.WARNING, (new StringBuilder(24 + str.length())).append("Unable to start Service ").append(str).toString(), e);
      } 
    } 
    return this;
  }
  ...
  private static final class ServiceManagerState {
    ...
    void markReady() {
      ...
      try {
        if (!this.transitioned) {
          ...
          String str1 = String.valueOf(String.valueOf("Services started transitioning asynchronously before the ServiceManager was constructed: ")), str2 = String.valueOf(String.valueOf(servicesInBadStates));
          throw new IllegalArgumentException((new StringBuilder(0 + str1.length() + str2.length())).append(str1).append(str2).toString());
        } 
      } finally {
        this.monitor.leave();
      } 
    ...
    void awaitHealthy(long timeout, TimeUnit unit) throws TimeoutException {
      ...
      try {
        if (!this.monitor.waitForUninterruptibly(this.awaitHealthGuard, timeout, unit)) {
          String str1 = String.valueOf(String.valueOf("Timeout waiting for the services to become healthy. The following services have not started: ")), str2 = String.valueOf(String.valueOf(Multimaps.filterKeys(this.servicesByState, Predicates.in((Collection)ImmutableSet.of(Service.State.NEW, Service.State.STARTING)))));
          throw new TimeoutException((new StringBuilder(0 + str1.length() + str2.length())).append(str1).append(str2).toString());
        } 
        checkHealthy();
      } finally {
        this.monitor.leave();
    ...
    void fireFailedListeners(final Service service) {
      String str = String.valueOf(String.valueOf(service));
      (new ListenerCallQueue.Callback<ServiceManager.Listener>((new StringBuilder(18 + str.length())).append("failed({service=").append(str).append("})").toString()) {
          void call(ServiceManager.Listener listener) {
    ...
    void checkHealthy() {
      if (this.states.count(Service.State.RUNNING) != this.numberOfServices) {
        String str = String.valueOf(String.valueOf(Multimaps.filterKeys(this.servicesByState, Predicates.not(Predicates.equalTo(Service.State.RUNNING)))));
        IllegalStateException exception = new IllegalStateException((new StringBuilder(79 + str.length())).append("Expected to be healthy after starting. The following services are not running: ").append(str).toString());
        throw exception;
      } 
    }
  }
  ...
  private static final class ServiceListener extends Service.Listener {
    ...
    public void failed(Service.State from, Throwable failure) {
      ...
      if (state != null) {
        if (!(this.service instanceof ServiceManager.NoOpService)) {
          String str1 = String.valueOf(String.valueOf(this.service)), str2 = String.valueOf(String.valueOf(from));
          ServiceManager.logger.log(Level.SEVERE, (new StringBuilder(34 + str1.length() + str2.length())).append("Service ").append(str1).append(" has failed in the ").append(str2).append(" state.").toString(), failure);
        } 
