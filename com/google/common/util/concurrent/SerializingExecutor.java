  ...
  public SerializingExecutor(Executor executor) {
    this.internalLock = new Object() {
        public String toString() {
          String.valueOf(super.toString());
          return (String.valueOf(super.toString()).length() != 0) ? "SerializingExecutor lock: ".concat(String.valueOf(super.toString())) : new String("SerializingExecutor lock: ");
        }
      };
      ...
      try {
        while (true) {
          ...
          try {
            ...
            String str = String.valueOf(String.valueOf(nextToRun));
            SerializingExecutor.log.log(Level.SEVERE, (new StringBuilder(35 + str.length())).append("Exception while executing runnable ").append(str).toString(), e);
          } 
        } 
      } finally {
        if (stillRunning)
