...
public final class InetAddresses {
  ...
  private static String convertDottedQuadToHex(String ipString) {
    ...
    String str1 = String.valueOf(String.valueOf(initialPart)), str2 = String.valueOf(String.valueOf(penultimate)), str3 = String.valueOf(String.valueOf(ultimate));
    return (new StringBuilder(1 + str1.length() + str2.length() + str3.length())).append(str1).append(str2).append(":").append(str3).toString();
  }
  ...
  public static String toUriString(InetAddress ip) {
    if (ip instanceof Inet6Address) {
      String str = String.valueOf(String.valueOf(toAddrString(ip)));
  ...
  public static InetAddress decrement(InetAddress address) {
    ...
    Preconditions.checkArgument((i >= 0), "Decrementing %s would wrap.", new Object[] { address });
