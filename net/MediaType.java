...
public final class MediaType {
  ...
  public Optional<Charset> charset() {
    ...
    String str = String.valueOf(String.valueOf(charsetValues));
    throw new IllegalStateException((new StringBuilder(33 + str.length())).append("Multiple charset values defined: ").append(str).toString());
  }
  ...
  public static MediaType parse(String input) {
    ...
    try {
      ...
      String str = String.valueOf(String.valueOf(input));
      throw new IllegalArgumentException((new StringBuilder(18 + str.length())).append("Could not parse '").append(str).append("'").toString(), e);
    } 
  }
