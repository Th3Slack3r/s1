  ...
  public static HostAndPort fromString(String hostPortString) {
    ...
    if (!Strings.isNullOrEmpty(portString)) {
      ...
      try {
        ...
        String.valueOf(hostPortString);
        throw new IllegalArgumentException((String.valueOf(hostPortString).length() != 0) ? "Unparseable port number: ".concat(String.valueOf(hostPortString)) : new String("Unparseable port number: "));
      } 
