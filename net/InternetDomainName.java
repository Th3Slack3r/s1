...
public final class InternetDomainName {
  ...
  public InternetDomainName child(String leftParts) {
    String str1 = String.valueOf(String.valueOf(Preconditions.checkNotNull(leftParts))), str2 = String.valueOf(String.valueOf(this.name));
    return from((new StringBuilder(1 + str1.length() + str2.length())).append(str1).append(".").append(str2).toString());
  }
