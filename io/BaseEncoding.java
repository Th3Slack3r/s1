...
public abstract class BaseEncoding {
  ...
  private static final class Alphabet extends CharMatcher {
    ...
    Alphabet(String name, char[] chars) {
      ...
      try {
        ...
        int k = chars.length;
        throw new IllegalArgumentException((new StringBuilder(35)).append("Illegal alphabet length ").append(k).toString(), e);
      } 
  ...
  static final class SeparatedBaseEncoding extends BaseEncoding {
    ...
    public String toString() {
      String str1 = String.valueOf(String.valueOf(this.delegate.toString())), str2 = String.valueOf(String.valueOf(this.separator));
      int i = this.afterEveryChars;
      return (new StringBuilder(31 + str1.length() + str2.length())).append(str1).append(".withSeparator(\"").append(str2).append("\", ").append(i).append(")").toString();
    }
  }
}
