...
public final class Closer implements Closeable {
  ...
  static final class LoggingSuppressor implements Suppressor {
    ...
    public void suppress(Closeable closeable, Throwable thrown, Throwable suppressed) {
      String str = String.valueOf(String.valueOf(closeable));
      Closeables.logger.log(Level.WARNING, (new StringBuilder(42 + str.length())).append("Suppressing exception thrown when closing ").append(str).toString(), suppressed);
    }
  }
